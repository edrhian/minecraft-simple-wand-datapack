...
execute as @a at @s if items entity @s weapon.mainhand warped_fungus_on_a_stick[custom_data={simple_wand:1b},custom_name="Simple Wand",enchantment_glint_override=true,unbreakable={}] if score @s simple_wand.trigger matches 1.. anchored eyes run function simple_wand:spell_init
